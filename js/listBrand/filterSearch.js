...
let labelBrand = document.querySelectorAll('.brandFilter label');
let words = [], mas1 = [], mas2 = [], mas3 = [], mas4 = [], mas5 = [];

filter.onclick = function(){
	let a= 0, b =0, c =0, d =0, f =0, sum =0;
	let indexSize = 0, indexSlovo = 0;
	...
	for(let i=0; i<labelBrand.length; i++){
		if(labelBrand[i].className == 'active-li'){
			f =1;
		}
	}
	for(let i=0; i<labelSize.length; i++){
